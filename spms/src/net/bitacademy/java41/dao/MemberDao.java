...
public class MemberDao {
	...
	public int change(Member member, Connection transactionConnection) throws Exception {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	public int photoChange(Member member, Connection transactionConnection, String photo) throws Exception {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	public int photoRemove(String email,Connection transactionConnection) throws Exception {
		Connection con = null;
		Statement stmt = null;
