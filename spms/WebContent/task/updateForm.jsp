...
*테스크 번호: <input type="text" name="no" value="${taskInfo.tno}" readonly><br>
*테스크명: <input type="text" name="name" value="${taskInfo.title}"><br>
*내용: <input type = "text" name="content"  value="${taskInfo.context }"><br>
